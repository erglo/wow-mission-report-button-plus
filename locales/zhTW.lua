...
ns.L = {
	...
	ENTRYTOOLTIP_LEGION_ASSAULTS_LABEL = "軍團入侵",
	ENTRYTOOLTIP_LEGION_ARGUS_INVASION_LABEL = "入侵點",
	...
	ENTRYTOOLTIP_DF_CAMP_AYLAAG_LABEL = "艾拉格營地",
	ENTRYTOOLTIP_DF_GRAND_HUNTS_LABEL = "大狩獵",
	ENTRYTOOLTIP_DF_COMMUNITY_FEAST_LABEL = "集體盛宴",
	ENTRYTOOLTIP_DF_DRAGONBANE_KEEP_LABEL = "攻打龍禍要塞",
	ENTRYTOOLTIP_DF_ELEMENTAL_STORMS_LABEL = "風暴之怒",
	ENTRYTOOLTIP_DF_FYRAKK_ASSAULTS_LABEL = "菲拉卡襲擊",
	...
	CFG_DDMENU_ICONHINT_TEXT = "任務完成提示",
	CFG_DDMENU_ICONHINT_TOOLTIP = "任務完成後，在選單的資料片名稱後面顯示一個驚嘆號。|n|n關閉此選項將不顯示驚嘆號提示。",
	CFG_DDMENU_ICONHINTALL_TEXT = "所有任務",
	CFG_DDMENU_ICONHINTALL_TOOLTIP = "所有任務都完成才顯示驚嘆號。",
	...
	CFG_DDMENU_ENTRYTOOLTIP_EVENT_POI_ELEMENTAL_STORMS = "巨龍群島的風暴之怒",
