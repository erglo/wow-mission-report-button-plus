...
ns.L = {
	...
	CFG_FACTION_REPUTATION_OTHER_FACTIONS_TEXT = "Weitere Fraktionen",
	CFG_FACTION_REPUTATION_OTHER_FACTIONS_TOOLTIP = "Zeigt den Fortschritt eures Rufes mit anderen für diese Erweiterung relevanten Fraktionen an, soweit verfügbar.",
	...
	CFG_DDMENU_SHOW_EXPANSION_ENTRY_TEXT = "Im Dropdownmenü anzeigen",
	CFG_DDMENU_SHOW_EXPANSION_ENTRY_TOOLTIP_S = "%s als Eintrag im Dropdownmenü des Minikarten-Buttons anzeigen/ausblenden.",
