...
ns.L = {
	...
	ENTRYTOOLTIP_DF_HIDE_MF_UNLOCK_DESCRIPTION_LABEL = "Entsperren Hinweis",
	...
	ENTRYTOOLTIP_DF_ELEMENTAL_STORMS_LABEL = "Elementarstürme",  -- Urstürme",
	--[[ UI options ]]--
	...
	CFG_DDMENU_ENTRYTOOLTIP_SHOW_MF_COLORS_TOOLTIP = "Die Namen der Hauptfraktionen werden in ihren jeweiligen Farben dargestellt.",
	-- CFG_DDMENU_ENTRYTOOLTIP_SHOW_DRAGON_GLYPHS_TEXT = "Drachenglyphen",
	CFG_DDMENU_ENTRYTOOLTIP_SHOW_DRAGON_GLYPHS_TOOLTIP = "Zeigt den bisherigen Fortschritt eurer gesammelten Drachenglyphen in den jeweiligen Zonen an.",
