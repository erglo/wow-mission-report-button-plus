...
ns.L = {
	...
	CFG_DDMENU_ICONHINT_TEXT = "Missionsabschluss-Hinweis",
	CFG_DDMENU_ICONHINT_TOOLTIP = "Auf der linken Seite des Menüs erscheint ein Hinweissymbol, sobald abgeschlossene Missionen verfügbar sind.|n|nWenn deaktiviert, wird dieses Symbol ausgeblendet.",
	CFG_DDMENU_ICONHINTALL_TEXT = "Erst nach Abschluss ALLER Missionen",
	CFG_DDMENU_ICONHINTALL_TOOLTIP = "Das Hinweissymbol erst anzeigen, wenn ALLE Missionen abgeschlossen wurden.",
	CFG_DDMENU_REPUTATION_HINT_TEXT = "Rufbelohnungshinweis",
	CFG_DDMENU_REPUTATION_HINT_TOOLTIP = "Auf der linken Seite des Menüs erscheint ein Hinweissymbol, sobald Rufbelohnung verfügbar wird.|n|nWenn deaktiviert, wird dieses Symbol ausgeblendet.",
