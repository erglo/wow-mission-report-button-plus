...
ns.L = {
	...
	CFG_DDMENU_ENTRYTOOLTIP_THREATS_TOOLTIP = "Listet die aktuellen Angriffe und Bedrohungen, wie z.B. N'Zoths Angriffe auf Uldum und Pandaria, sowie die Panktangriffe im Schlund an, sobald sie freigeschaltet wurden.",
