...
ns.L = {
	...
	CFG_MINIMAPBUTTON_USE_MIDDLE_BUTTON_TEXT = "Use Middle Button",
	CFG_MINIMAPBUTTON_USE_MIDDLE_BUTTON_TOOLTIP = "Activate for toggling the Skyriding Skill Tree by clicking the Middle Button on the Minimap Mutton as well as on the Addon Compartment entry.",
