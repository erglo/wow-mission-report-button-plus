...
ns.L = {
	...
	CFG_DDMENU_ENTRYTOOLTIP_SHOW_MF_COLORS_TEXT = "Use Major Faction Colors",
	CFG_DDMENU_ENTRYTOOLTIP_SHOW_MF_COLORS_TOOLTIP = "Displays the major faction names in their respective colors.",
	CFG_DDMENU_ENTRYTOOLTIP_SHOW_DRAGON_GLYPHS_TEXT = "Collected Dragon Glyphs",
	CFG_DDMENU_ENTRYTOOLTIP_SHOW_DRAGON_GLYPHS_TOOLTIP = "Shows the progress of your Dragon Glyphs collection.",
	CFG_DDMENU_ENTRYTOOLTIP_HIDE_DRAGON_GLYPHS_TEXT = "Hide On Completion",
