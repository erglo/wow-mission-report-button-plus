...
ns.L = {
	...
	CFG_DDMENU_HIGHLIGHT_WATCHED_FACTION_TEXT = "Highlight Watched Faction",
	CFG_DDMENU_HIGHLIGHT_WATCHED_FACTION_TOOLTIP = "The currently watched faction from the Experience Bar will be highlighted in the tooltip, if available.",
	CFG_DDMENU_REWARD_PENDING_FACTION_TEXT = "Highlight Reward Pending Faction",
	CFG_DDMENU_REWARD_PENDING_FACTION_TOOLTIP = "Highlight the tooltip lines of the factions with a reward pending.",
	CFG_DDMENU_REPUTATION_SHOW_WARBAND_ICON_TEXT = "Show Warband Reputation Icon",
	CFG_DDMENU_REPUTATION_SHOW_WARBAND_ICON_TOOLTIP = "Displays a warband icon behind a faction's name, if it's reputation is account-wide.|n|n(This only affects Dragonflight and newer expansions.)",
