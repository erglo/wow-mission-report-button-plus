...
ns.L = {
	...
	CFG_DDMENU_REPORTICONS_TEXT = "Show Landing Page Icons",
	CFG_DDMENU_REPORTICONS_TOOLTIP = "If disabled, the expansion type icons on the right side of the menu will be hidden.",
	CFG_DDMENU_ICONHINT_TEXT = "Show Mission Hint Icon",
	CFG_DDMENU_ICONHINT_TOOLTIP = "An icon appears on the left side of the menu indicating that completed missions are available.|n|nIf disabled, the icon will not be displayed.",
	...
	CFG_DDMENU_REPUTATION_HINT_TEXT = "Show Reward Hint Icon",
	CFG_DDMENU_REPUTATION_HINT_TOOLTIP = "An icon appears on the left side of the menu indicating that reputation reward is available.|n|nIf disabled, the icon will not be displayed.",
