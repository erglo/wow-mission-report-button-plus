...
ns.L = {
	...
	CFG_MINIMAPBUTTON_MOUSE_OVER_MINIMAP_MODE_TEXT = "Dynamic Minimap Button",
	CFG_MINIMAPBUTTON_MOUSE_OVER_MINIMAP_MODE_TOOLTIP = "In this mode the Minimap Button will only be visible when the mouse is entering the Minimap area or the Minimap Button itself.",
	CFG_MINIMAPBUTTON_USE_MIDDLE_BUTTON_TEXT = "Utilize Middle Button",
	CFG_MINIMAPBUTTON_USE_MIDDLE_BUTTON_TOOLTIP = "Activate for toggling the Skyriding Skill Tree by clicking the middle mouse button on the Minimap Button as well as on the Addon Compartment entry.",
	...
	CFG_DDMENU_REPORTICONS_TEXT = "Show Expansion Icons",
	CFG_DDMENU_REPORTICONS_TOOLTIP = "If disabled, the expansion type icons on the right side of the menu will be hidden.",
	CFG_DDMENU_HINT_MISSIONS_TEXT = "Hint Completed Missions",
	CFG_DDMENU_HINT_MISSIONS_TOOLTIP = "An icon appears on the left side of the menu as soon as completed missions are available.",
	CFG_DDMENU_HINT_MISSIONS_ALL_TEXT = "Only after Finishing ALL Missions",
	CFG_DDMENU_HINT_MISSIONS_ALL_TOOLTIP = "The hinting icon will only show up after ALL in-progress missions were finished.",
	...
	CFG_DDMENU_HIGHLIGHT_CURRENT_ZONE_TEXT = "Highlight Current Zone",
	CFG_DDMENU_HIGHLIGHT_CURRENT_ZONE_TOOLTIP = "If activated, the expansion line for the current zone will be highlighted.",
	CFG_DDMENU_REPUTATION_HIGHLIGHT_WATCHED_FACTION_TEXT = "Highlight Watched Faction",
	CFG_DDMENU_REPUTATION_HIGHLIGHT_WATCHED_FACTION_TOOLTIP = "The currently watched faction from the Experience Bar will be highlighted in the tooltip, if available.",
	CFG_DDMENU_REPUTATION_REWARD_PENDING_FACTION_TEXT = "Highlight Reward Pending Faction",
	CFG_DDMENU_REPUTATION_REWARD_PENDING_FACTION_TOOLTIP = "Highlight the tooltip lines of the factions with a reward pending.",
	CFG_DDMENU_REPUTATION_SHOW_WARBAND_ICON_TEXT = "Show Warband Reputation Icon",
	CFG_DDMENU_REPUTATION_SHOW_WARBAND_ICON_TOOLTIP = "Displays a warband icon behind a faction name, if it's an account-wide reputation.",
	...
	CFG_FACTION_REPUTATION_OTHER_FACTIONS_TEXT = "Other Factions",
	...
	CFG_DDMENU_ENTRYTOOLTIP_EVENT_POI_THEATER_TROUPE = "the Theater Troupe on the Isle of Dorn",
	...
	CFG_DDMENU_SHOW_EXPANSION_ENTRY_TEXT = "Show in Dropdown Menu",
	CFG_DDMENU_SHOW_EXPANSION_ENTRY_TOOLTIP_S = "Show/Hide %s as menu entry in the minimap button's right-click menu.",
	CFG_DDMENU_STYLESELECTION_LABEL = "Menu Style",
	CFG_DDMENU_STYLESELECTION_TOOLTIP = "Choose your favorite dropdown menu style.",
	...
	CFG_APPEARANCE_DIMENSIONS_LINE_HEIGHT_TEXT = "Line Height",
	CFG_APPEARANCE_DIMENSIONS_LINE_HEIGHT_TOOLTIP = "Set the height for each line.",
	CFG_APPEARANCE_TEXT_ALIGNMENT_TOOLTIP = "Align the text to this side.",
	CFG_APPEARANCE_TEXT_ALIGNMENT_CENTERED_TEXT = "Center",
	CFG_APPEARANCE_TEXT_PADDING_TEXT = "Padding",
	CFG_APPEARANCE_TEXT_PADDING_TOOLTIP = "Set the padding between text and menu border.",
	CFG_APPEARANCE_TEXT_COLOR_TEXT = "Text Color",
	CFG_APPEARANCE_TEXT_COLOR_TOOLTIP = "Choose the text color of your liking.",
	CFG_APPEARANCE_COLOR_BUTTON_TEXT = "Choose a Color...",
	...
	CFG_APPEARANCE_ANCHOR_POINT_BUTTON_TOOLTIP = "Set the minimap button's anchor point.",
	CFG_APPEARANCE_ANCHOR_DISTANCE_TEXT = "Spacing",
	...
	WORKS_ONLY_FOR_EXPANSION_S = "(Currently only supported by %s and newer expansions.)",
	AFFECTS_ONLY_EXPANSIONS_DF_AND_NEWER = "(This only affects Dragonflight and newer expansions.)",
};