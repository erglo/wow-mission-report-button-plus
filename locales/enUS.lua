...
ns.L = {
	...
	ENTRYTOOLTIP_LEGION_ARGUS_INVASION_LABEL = "Invasion Points",
	...
	-- CFG_DDMENU_ENTRYTOOLTIP_BOUNTYREQUIREMENTS_TEXT = "Bounties: Show Turn-in Requirements",
	...
	-- CFG_DDMENU_ENTRYTOOLTIP_THREATS_TIMELEFT_TEXT = "Threats: Show time remaining",
