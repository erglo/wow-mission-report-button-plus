...
ns.L = {
	...
	CFG_DDMENU_ENTRYTOOLTIP_BOUNTIES_TOOLTIP = "Lists the currently active Emissary Quests of each expansion which supports these, if they were unlocked by the player.",
	CFG_DDMENU_ENTRYTOOLTIP_THREATS_TEXT = "Show World Map Threats",
	CFG_DDMENU_ENTRYTOOLTIP_THREATS_TOOLTIP = "Lists the currently active world map threats (eg. N'Zoth or Covenant assaults) of each expansion which supports these, if they were unlocked by the player.",
