...
ns.L = {
	...
	CFG_DDMENU_ICONHINT_TOOLTIP = "After each menu item an exclamation icon appears as soon as an in-progress mission is finished.|n|nIf disabled, the icon will be hidden.",
	...
	CFG_DDMENU_ENTRYTOOLTIP_BOUNTIES_TOOLTIP = "Lists the currently active and unlocked Emissary Quests available for each expansion.",
	CFG_DDMENU_ENTRYTOOLTIP_BOUNTYREQUIREMENTS_TEXT = "Show Turn-in Requirements",
	CFG_DDMENU_ENTRYTOOLTIP_BOUNTYREQUIREMENTS_TOOLTIP = "Some Emissary Quests appear as available although the World Quests for that faction haven't been unlocked.|n|nEnable in order to show an unlocking requirement hint.",
	CFG_DDMENU_ENTRYTOOLTIP_THREATS_TEXT = "World Map Threats",
	CFG_DDMENU_ENTRYTOOLTIP_THREATS_TOOLTIP = "Lists the currently active and unlocked world map threats (eg. N'Zoth or Covenant assaults) for each expansion.",
	CFG_DDMENU_ENTRYTOOLTIP_SHOW_REQUIREMENT_TEXT = "Include Requirements",
	CFG_DDMENU_ENTRYTOOLTIP_SHOW_REQUIREMENT_TOOLTIP = "An expansion's mission report cannot be accessed unless its command table is unlocked.|n|nEnable to show an unlocking requirement hint in the entry tooltip.",
	CFG_DDMENU_ENTRYSELECTION_LABEL = "Menu Items",
	CFG_DDMENU_ENTRYSELECTION_TOOLTIP = "Choose the dropdown menu's entry items which should be displayed. Simply uncheck those items which are no longer of interest to you.",
