...
ns.L = {
	...
	CFG_DDMENU_ICONHINT_TOOLTIP = "An icon appears on the left side of the menu as soon as completed missions are available.|n|nIf disabled, the icon will not be displayed.",
	...
	CFG_DDMENU_REPUTATION_HINT_TOOLTIP = "An icon appears on the left side of the menu as soon as reputation reward is available.|n|nIf disabled, the icon will not be displayed.",
