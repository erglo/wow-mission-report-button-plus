...
L.MAJOR_FACTION_RENOWN_CURRENT_PROGRESS = MAJOR_FACTION_RENOWN_CURRENT_PROGRESS
L.COVENANT_SANCTUM_RENOWN_REWARD_TITLE_COMPLETE = COVENANT_SANCTUM_RENOWN_REWARD_TITLE_COMPLETE
L.PVP = PVP
L.RENOWN_LEVEL_LABEL = RENOWN_LEVEL_LABEL
L.UNKNOWN = UNKNOWN
...
-- L["BonusFactionReputationLabel"] = GUILD_MEMBER_TEMPLATE:format(FACTION, FACTION_OTHER)..L.TEXT_DELIMITER..PARENS_TEMPLATE:format(REPUTATION)
L["BonusFactionReputationLabel"] = L.CFG_FACTION_REPUTATION_OTHER_FACTIONS_TEXT..L.TEXT_DELIMITER..PARENS_TEMPLATE:format(REPUTATION)
